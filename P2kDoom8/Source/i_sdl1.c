 ...
 *
 * EXL, 04-Aug-2025:
 *      SDL1 platfrom implementation based on i_vvga13.c blitter by FrenkelS.
 *
 *-----------------------------------------------------------------------------*/
...
//			palette_sdl[p].a = 0xFF;
		...
		SDL_SetPalette(surface, SDL_LOGPAL | SDL_PHYSPAL, (SDL_Color *) palette_sdl, 0, 256);
...
void I_InitGraphicsHardwareSpecificCode(void)
{
	...
	video = SDL_SetVideoMode(screen_width, screen_height, 16, SDL_HWSURFACE);
	if (video == NULL) {
